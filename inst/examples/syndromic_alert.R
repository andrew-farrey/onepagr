# Canonical example data for this template, installed with the package.
# Backs the public example_data()/template_data() helpers (see
# R/example-data.R) and this package's own tests -- one source of
# truth, not a copy hand-typed in more than one place.
