...
This is the actual PDF that call just produced, built from the real
`z = 2.59` finding computed above, not placeholder text:

```{r, eval = pdftools_ready, echo = FALSE}
front_page <- pdftools::pdf_convert(
  out, pages = 1, dpi = 100,
  filenames = file.path(tempdir(), "end-to-end-syndromic-alert.png"),
  verbose = FALSE
)
