...
This is the actual PDF `render_onepager()` just produced above (front
page; `cohort_summary` is a fixed two-page template, so a matching back
page follows it in the real file):
